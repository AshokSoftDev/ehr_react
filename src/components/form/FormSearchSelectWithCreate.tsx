...
type FormSearchSelectWithCreateProps<
...
export function FormSearchSelectWithCreate<
  TFieldValues extends FieldValues,
  TName extends FieldPath<TFieldValues>
>(props: FormSearchSelectWithCreateProps<TFieldValues, TName>) {
  const {
    control,
    name,
    label,
              ...
              <Popover open={open} onOpenChange={setOpen}>
                ...
                >
                  ...
                  >
                    ...
                    <ScrollArea className="max-h-[calc(60vh-3.5rem)] sm:max-h-[calc(50vh-3rem)]">
